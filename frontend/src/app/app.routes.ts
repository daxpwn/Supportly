...
export const routes: Routes = [
  ...
  { path: 'audit-log', component: AuditLogComponent, canActivate: [authGuard, roleGuard('admin')] },
  { path: 'roles', component: RolesComponent, canActivate: [authGuard, roleGuard('admin')] }
];